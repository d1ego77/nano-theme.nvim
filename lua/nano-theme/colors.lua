...
function M.get()
  ...
  local nano_background_color = is_light_theme and "#F3F3F3" or "#2E3440"
  local nano_highlight_color  = is_light_theme and "#a9e9a9" or "#3B4252"
  ...
  --local nano_salient_color    = is_light_theme and "#325CC0" or "#81A1C1"
  local nano_strong_color     = is_light_theme and "#0000AA" or "#FFFFFF"
